<div class="row">
	<div class="col-md-12">
        <div class="box box-success">
        	<?php echo form_open('',['id' => 'client-service-tax-form']); ?>
        	<div class="box-header">
                <h3 class="box-title"><?php echo ($client_service_tax_id == 0)?'Add':'Edit'; ?> Service Tax</h3>
                <a href="<?php echo base_url('manage-client-service-taxes/'.$client_id); ?>" class="btn btn-success pull-right">Manage Client Service Taxes</a>
            </div>
            <div class="box-body">
            	<div class="row">
            		<div class="col-md-4">
