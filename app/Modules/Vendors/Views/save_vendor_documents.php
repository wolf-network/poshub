    ...
    <div class="col-md-12">
        <div class="box box-success">
            ...
            <div class="box-header">
                <h3 class="box-title">Add Vendor Documents</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="CityID" required class="form-control bs_multiselect city" data-non-selected-text="Select City" data-selected_city="<?php echo set_value('CityID'); ?>" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="text-danger"><?php echo validation_show_error('DocumentFile.'.$i); ?></span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
