        ...
        <div class="box box-success">
            <div class="box-header">
                ...
                <div class="pull-right">
                    ...
                    <a href="<?php echo base_url('add-industry'); ?>" class="btn btn-success <?php echo $btn_class; ?>">Add Industry</a>
                </div>
            </div>
            <div class="box-body">
                <div class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
                    <table class="table table-bordered table-hover dataTable shadow commonDataTable" data-url="<?php echo base_url('api/management/get_industries') ?>" data-responsive="true">
                        <thead>
                            <tr>
                                ...
                                <?php 
                                    $action_btn = "<a href='".base_url('edit-industry/')."{BusinessIndustryID}' class='btn btn-warning btn-xs' title='edit'><i class='fa fa-edit'></i></a>";
                                    if($subscription_time_left['years'] >=0 && $subscription_time_left['months'] >=0 && $subscription_time_left['days'] >= 0 && $subscription_time_left['hours'] >= 0 && $subscription_time_left['minutes'] >= 0 && $subscription_time_left['seconds'] > 0 && session()->get('user_data')['Privilege'] == 'Admin'){
                                        $action_btn .= " <button data-industry_id='{BusinessIndustryID}' class='btn btn-danger btn-xs delete-industry' title='delete'><i class='fa fa-trash'></i></button>";
                                ?>
